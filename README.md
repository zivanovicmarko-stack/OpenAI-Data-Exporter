...
<table width="100%" cellspacing="0" cellpadding="0" bgcolor="#0d1117">
  <tr>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/01%20-%20Initial%20state.png"><img src="readme_files/01%20-%20Initial%20state.png" alt="Initial exporter state" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/02%20-%20OpenAI%20Data%20Export%20ZIP%20selected.png"><img src="readme_files/02%20-%20OpenAI%20Data%20Export%20ZIP%20selected.png" alt="OpenAI Data Export ZIP selected" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
  </tr>
  <tr>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        ...
        <sub>Load or drop the official OpenAI data export ZIP.</sub>
      </div>
    </td>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        <strong>Select export ZIP</strong><br />
        <sub>The selected ZIP is ready for <code>Begin Extraction...</code>.</sub>
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/03%20-%20Extracting%20chats%20from%20Data%20Export%20ZIP.png"><img src="readme_files/03%20-%20Extracting%20chats%20from%20Data%20Export%20ZIP.png" alt="Extracting chats from Data Export ZIP" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/04%20-%20Chats%20List%20-%20Initial%20view.png"><img src="readme_files/04%20-%20Chats%20List%20-%20Initial%20view.png" alt="Chats List initial view" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
  </tr>
  <tr>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        ...
        <sub>Extract conversations locally from the selected OpenAI data export ZIP.</sub>
      </div>
    </td>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        <strong>Review chats</strong><br />
        <sub>Search, sort and select extracted conversations.</sub>
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/05%20-%20Choose%20export%20folder.png"><img src="readme_files/05%20-%20Choose%20export%20folder.png" alt="Choose export folder" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/06%20-%20Allow%20browser%20to%20write%20in%20selected%20export%20folder.png"><img src="readme_files/06%20-%20Allow%20browser%20to%20write%20in%20selected%20export%20folder.png" alt="Allow browser to write in selected export folder" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
  </tr>
  <tr>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        ...
        <sub>Choose the folder where exported files will be written.</sub>
      </div>
    </td>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        <strong>Allow folder access</strong><br />
        <sub>Allow the browser to write files to the selected export folder.</sub>
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/07%20-%20File%20Types%20menu.png"><img src="readme_files/07%20-%20File%20Types%20menu.png" alt="File Types menu" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/08%20-%20Start%20exporting%20selected%20chats.png"><img src="readme_files/08%20-%20Start%20exporting%20selected%20chats.png" alt="Start exporting selected chats" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
  </tr>
  <tr>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        ...
        <sub>Choose <code>All File Types</code>, <code>MD Files Only</code> or <code>PDF Files Only</code>.</sub>
      </div>
    </td>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        <strong>Start bulk export</strong><br />
        <sub>Start exporting the selected conversations to the chosen folder.</sub>
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/09%20-%20Bulk%20extraction%20-%20Disabled%20Choose%20export%20folder.png"><img src="readme_files/09%20-%20Bulk%20extraction%20-%20Disabled%20Choose%20export%20folder.png" alt="Choose export folder disabled during bulk export" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/10%20-%20Bulk%20extraction%20-%20Disabled%20single%20chats%20downloads.png"><img src="readme_files/10%20-%20Bulk%20extraction%20-%20Disabled%20single%20chats%20downloads.png" alt="Single chat downloads disabled during bulk export" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
  </tr>
  <tr>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        ...
        <sub><code>Choose export folder</code> remains disabled while the current bulk export is running.</sub>
      </div>
    </td>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        <strong>Single-file saves disabled</strong><br />
        <sub><code>Save MD</code> and <code>Save PDF</code> remain disabled while the current bulk export is running.</sub>
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/11%20-%20Bulk%20extraction%20-%20Disabled%20Reset%20action.png"><img src="readme_files/11%20-%20Bulk%20extraction%20-%20Disabled%20Reset%20action.png" alt="Reset action disabled during bulk export" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/12%20-%20Additional%20content%20found.png"><img src="readme_files/12%20-%20Additional%20content%20found.png" alt="Additional Content found" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
  </tr>
  <tr>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        ...
        <sub>Reset exporter remains unavailable until the current bulk export finishes, as well as any other action except &quot;Cancel&quot;.</sub>
      </div>
    </td>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        <strong>Additional Content</strong><br />
        <sub>Potentially recoverable content was detected after the basic export.</sub>
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/13%20-%20Processing%20additional%20content%20for%20selected%20exports.png"><img src="readme_files/13%20-%20Processing%20additional%20content%20for%20selected%20exports.png" alt="Processing Additional Content for selected exports" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/14%20-%20Result%20of%20second%20pass.png"><img src="readme_files/14%20-%20Result%20of%20second%20pass.png" alt="Finished Additional Content result" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
  </tr>
  <tr>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        ...
        <sub><code>Working...</code> processes Additional Content for the selected exports.</sub>
      </div>
    </td>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        <strong>Finished</strong><br />
        <sub><code>Finished</code> shows which exported files were updated.</sub>
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/15%20-%20Back%20to%20exporter%20on%20Close.png"><img src="readme_files/15%20-%20Back%20to%20exporter%20on%20Close.png" alt="Back to exporter on Close" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
    <td width="50%" valign="top" align="left" bgcolor="#0d1117">
      <a href="readme_files/16%20-%20Exported%20folders%20and%20files.png"><img src="readme_files/16%20-%20Exported%20folders%20and%20files.png" alt="Exported folders and files" width="100%" border="0" hspace="0" vspace="0" /></a>
    </td>
  </tr>
  <tr>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        ...
        <sub>Close the result to return to the exporter and continue working.</sub>
      </div>
    </td>
    <td width="50%" height="64" valign="middle" align="center" bgcolor="#0d1117">
      <div align="center">
        <strong>Exported files</strong><br />
        <sub>Review the resulting Markdown, PDF and available Assets in the selected folder.</sub>
      </div>
    </td>
  </tr>
</table>